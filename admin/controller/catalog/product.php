...
class ControllerCatalogProduct extends Controller {
    ...
    private function validateForm() {
        ...
        foreach($this->request->post['product_description'] as $language_id => $value){
            if ((utf8_strlen(utf8_decode($value['reason'])) < $rules['str_lenth'])) {
                $this->error['reason'][$language_id] = $this->language->get('error_reason');
            }
        }
        
        foreach($this->request->post['product_description'] as $language_id => $value){
            if ((utf8_strlen(utf8_decode($value['description'])) < $rules['str_lenth'])) {
