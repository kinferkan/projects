...
//        }
        ...
        if (isset($data['category_layout'])) {
              if ($layout['layout_id']) {
                  $this->db->query("INSERT INTO " . DB_PREFIX . "category_to_layout SET category_id = '" . (int) $category_id . "', layout_id = '" . (int) $layout['layout_id'] . "'");
              }
        }
...
//    }
    ...
    public function getCategoryLayouts($category_id) {
        ...
        foreach ($query->rows as $result) {
            $category_layout_data[$result['layout_id']] = $result['layout_id'];
        }
